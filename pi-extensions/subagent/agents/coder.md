...
When ready, invoke the code reviewer agent and requesting a code review. 
...
**2. Dispatch senior-code-reviewer subagent:**
...
[Dispatch senior-code-reviewer subagent]
...
Load receiving-code-review skill to handle the review.
